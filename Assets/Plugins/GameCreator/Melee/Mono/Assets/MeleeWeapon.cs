namespace GameCreator.Melee
{
    ...
    public class MeleeWeapon : ScriptableObject
	{
        ...
        public List<MeleeClip> groundHitReactionsUpperDown = new List<MeleeClip>();
        public List<MeleeClip> groundHitReactionsDownerUp = new List<MeleeClip>();
        public List<MeleeClip> groundHitReactionsLeft = new List<MeleeClip>();
        public List<MeleeClip> groundHitReactionsRight = new List<MeleeClip>();
        ...
        public MeleeClip GetHitReaction(bool isGrounded,bool frontalAttack, MeleeClip.Direction direction, bool isKnockback)
        {
            int index;
            ...
            switch (isGrounded)
            {
                case true:
                    switch (direction)
                    {
                        ...
                        case MeleeClip.Direction.Front:
                            ...
                            break;
                        case MeleeClip.Direction.Behind:
                            ...
                            break;
                        case MeleeClip.Direction.UpperDown:
                            index = UnityEngine.Random.Range(0, this.groundHitReactionsUpperDown.Count);
                            if (this.groundHitReactionsUpperDown.Count != 1 && index == this.prevRandomHit) index++;
                            this.prevRandomHit = index;
                            meleeClip = this.groundHitReactionsUpperDown[index];
                            break;
                        case MeleeClip.Direction.DownerUp:
                            index = UnityEngine.Random.Range(0, this.groundHitReactionsDownerUp.Count);
                            if (this.groundHitReactionsDownerUp.Count != 1 && index == this.prevRandomHit) index++;
                            this.prevRandomHit = index;
                            meleeClip = this.groundHitReactionsDownerUp[index];
                            break;
                        case MeleeClip.Direction.Left:
                            index = UnityEngine.Random.Range(0, this.groundHitReactionsLeft.Count);
                            if (this.groundHitReactionsLeft.Count != 1 && index == this.prevRandomHit) index++;
                            this.prevRandomHit = index;
                            meleeClip = this.groundHitReactionsLeft[index];
                            break;
                        case MeleeClip.Direction.Right:
                            index = UnityEngine.Random.Range(0, this.groundHitReactionsRight.Count);
                            if (this.groundHitReactionsRight.Count != 1 && index == this.prevRandomHit) index++;
                            this.prevRandomHit = index;
                            meleeClip = this.groundHitReactionsRight[index];
                            break;
                        default:
