namespace GameCreator.Melee
{
	...
	public class MeleeWeaponEditor : IMeleeEditor
	{
        ...
        private SerializedProperty spGroundHitReactionUpperDown;
        private SerializedProperty spGroundHitReactionDownerUp;
        private SerializedProperty spGroundHitReactionLeft;
        private SerializedProperty spGroundHitReactionRight;
        ...
        private ReorderableList groundHitReactionsUpperDown;
        private ReorderableList groundHitReactionsDownerUp;
        private ReorderableList groundHitReactionsLeft;
        private ReorderableList groundHitReactionsRight;
        ...
        private void OnEnable()
        {
            ...
            this.spGroundHitReactionUpperDown = this.serializedObject.FindProperty("groundHitReactionsUpperDown");
            this.spGroundHitReactionDownerUp = this.serializedObject.FindProperty("groundHitReactionsDownerUp");
            this.spGroundHitReactionLeft = this.serializedObject.FindProperty("groundHitReactionsLeft");
            this.spGroundHitReactionRight = this.serializedObject.FindProperty("groundHitReactionsRight");
            ...
            this.groundHitReactionsUpperDown = new ReorderableList(
                this.serializedObject,
                this.spGroundHitReactionUpperDown,
                true, true, true, true
            );
            this.groundHitReactionsDownerUp = new ReorderableList(
                this.serializedObject,
                this.spGroundHitReactionDownerUp,
                true, true, true, true
            );
            this.groundHitReactionsLeft = new ReorderableList(
                this.serializedObject,
                this.spGroundHitReactionLeft,
                true, true, true, true
            );
            this.groundHitReactionsRight = new ReorderableList(
                this.serializedObject,
                this.spGroundHitReactionRight,
                true, true, true, true
            );
            ...
            this.groundHitReactionsUpperDown.drawHeaderCallback += this.PaintHitGroundUpperDown_Title;
            this.groundHitReactionsDownerUp.drawHeaderCallback += this.PaintHitGroundDownerUp_Title;
            this.groundHitReactionsLeft.drawHeaderCallback += this.PaintHitGroundLeft_Title;
            this.groundHitReactionsRight.drawHeaderCallback += this.PaintHitGroundRight_Title;
            ...
            this.groundHitReactionsUpperDown.drawElementCallback += this.PaintHitGroundUpperDown_Element;
            this.groundHitReactionsDownerUp.drawElementCallback += this.PaintHitGroundDownerUp_Element;
            this.groundHitReactionsLeft.drawElementCallback += this.PaintHitGroundLeftElement;
            this.groundHitReactionsRight.drawElementCallback += this.PaintHitGroundRight_Element;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Space();
            this.groundHitReactionsDownerUp.DoLayoutList();
            
            EditorGUILayout.Space();
            this.groundHitReactionsUpperDown.DoLayoutList();
            
            EditorGUILayout.Space();
            this.groundHitReactionsLeft.DoLayoutList();
            
            EditorGUILayout.Space();
            this.groundHitReactionsRight.DoLayoutList();
        ...
        private void PaintHitGroundUpperDown_Title(Rect rect)
        {
            EditorGUI.LabelField(rect, "Hit Reaction - Grounded & UpperDown");
        }
        
        private void PaintHitGroundDownerUp_Title(Rect rect)
        {
            EditorGUI.LabelField(rect, "Hit Reaction - Grounded & DownerUp");
        }
        ...
        private void PaintHitGroundUpperDown_Element(Rect rect, int index, bool isActive, bool isFocused)
        {
            rect = new Rect(
                rect.x, rect.y + (rect.height - EditorGUIUtility.singleLineHeight) / 2f,
                rect.width, EditorGUIUtility.singleLineHeight
            ...
            EditorGUI.PropertyField(
                rect, this.spGroundHitReactionUpperDown.GetArrayElementAtIndex(index),
                GC_REACTION, true
            );
        }
        private void PaintHitGroundDownerUp_Element(Rect rect, int index, bool isActive, bool isFocused)
        {
            rect = new Rect(
                rect.x, rect.y + (rect.height - EditorGUIUtility.singleLineHeight) / 2f,
                rect.width, EditorGUIUtility.singleLineHeight
            ...
            EditorGUI.PropertyField(
                rect, this.spGroundHitReactionDownerUp.GetArrayElementAtIndex(index),
                GC_REACTION, true
            );
        }
        private void PaintHitGroundLeftElement(Rect rect, int index, bool isActive, bool isFocused)
        {
            rect = new Rect(
                rect.x, rect.y + (rect.height - EditorGUIUtility.singleLineHeight) / 2f,
                rect.width, EditorGUIUtility.singleLineHeight
            ...
            EditorGUI.PropertyField(
                rect, this.spGroundHitReactionLeft.GetArrayElementAtIndex(index),
                GC_REACTION, true
            );
        }
        private void PaintHitGroundRight_Element(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            EditorGUI.PropertyField(
                rect, this.spGroundHitReactionRight.GetArrayElementAtIndex(index),
                GC_REACTION, true
            );
        }
